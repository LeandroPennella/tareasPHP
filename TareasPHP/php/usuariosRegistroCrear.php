...
require_once '../scripts/registroCrear.inc.php';
?>
...
<div class="panel panelRegistro">
	...
	<h1>Formulario de Registro</h1>
		...
		<form action="usuariosRegistroCrear.php" method="post" enctype="multipart/form-data">
		...
		<?php
		} else if (isset($_POST['nombreFoto']))
		{
			$rutaImagen=DIR_FOTOPERFIL.$_POST['nombreFoto'];
			?>
					<img src="<?php print ($rutaImagen); ?>" width="200" height="200"><br>
					<input type="text" name="nombreFoto" value="<?php echo $_POST['nombreFoto'] ?>" >
						<?php 
